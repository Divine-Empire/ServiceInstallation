...
const Dashboard = () => {
  ...
  const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzuNLpnDvKCNwtfWvNttA3SZEl0EBNTdszqFDRu4eqjrQSJvy9lA7UG-NAGrbMqCx5d/exec";
  ...
  // Direct file view handler - opens file in new tab (same as ServiceIntimation)
                  ...
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-sm text-gray-500 border-r border-gray-100">
                      {order["Invoice Copy Upload"] ? (
                        <button
                          onClick={() => handleFileView(order["Invoice Copy Upload"])}
